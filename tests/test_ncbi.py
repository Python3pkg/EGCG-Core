...
def reset_cache():
    ...
    ncbi.cursor.execute(_create + 'species (taxid text UNIQUE, scientific_name text UNIQUE, common_name text)')
    ncbi.cursor.execute(_create + 'aliases (query_name text UNIQUE, taxid text REFERENCES species(taxid))')
